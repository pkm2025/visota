...
Tracks deduction and bracket changes across 5 PIT law periods:
  ...
  4. 2026-01-01 → 2026-06-30  Luật 09/2026/QH16 (hiệu lực 01/01/2026) (GTGC 13.2M, NPT 5.2M, 5 bậc)
  5. 2026-07-01 → now         NQ 110/2025/UBTVQH15 + Luật 09/2026/QH16 (GTGC 15.5M, NPT 6.2M, 5 bậc)
"""
...
PIT_HISTORY = [
    ...
    # 2026-01-01 → 2026-06-30 (Luật 09/2026/QH16 — hiệu lực từ kỳ tính thuế năm 2026)
    ...
    # 2026-07-01 → hiện tại (NQ 110/2025/UBTVQH15 — hiệu lực từ 01/07/2026)
    # GTGC 15.5M/tháng (186M/năm), NPT 6.2M, 5 bậc lũy tiến 5%/10%/20%/30%/35%.
    {
        ...
        "brackets": [
            ...
            [32000000, 0.30],
            [999999999, 0.35],
        ],  # 5 bậc theo NQ 110/2025 + Luật 09/2026/QH16
        "legal_basis": "NQ 110/2025/UBTVQH15 (hiệu lực từ 01/07/2026)",
        "is_current": True,
    },
]
...
class Command(BaseCommand):
    help = "Seed PIT rate history (5 periods: 2009, 2013, 2020, 2026-01, 2026-07)."
